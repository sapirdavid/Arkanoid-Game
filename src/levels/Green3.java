...
/**
 * the class describe a level - Green3.
...
public class Green3 implements LevelInformation {
    ...
    public static final int BALLS_AMOUNT = 2;
    public static final int BLOCKS_AMOUNT = 40;
    public static final int LEVEL_NUMBER = 3;
    public static final int ANGLE_BASE = -10;
    ...
    public List<Velocity> initialBallVelocities() {
        for (int i = 0; i < numberOfBalls; i++) {
            double angle = (ANGLE_BASE * i) + 50;
            double speed = BALL_SPEED;
            if (i == 0) {
               angle = (ANGLE_BASE * i) - 40;
            }
    ...
    public List<Block> createBlocks() {
        ...
        Color[] colors = {Color.orange, Color.red, Color.magenta, Color.green,
